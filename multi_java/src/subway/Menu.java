...
class ShowMenu extends JFrame//메뉴 선택 GUI 출력
{
	...
	public ShowMenu()
	{
		...
		*/
		...
		//////////// 4. 메뉴사진(bt)
		btEgg = new JButton("",new ImageIcon("C:\\Users\\하은\\git\\java\\multi_java\\Image\\에그토스트.jpg")); //메뉴사진(bt) 생성
		btBacon = new JButton("",new ImageIcon("C:\\Users\\하은\\git\\java\\multi_java\\Image\\베이컨토스트.jpg"));
		btCheese = new JButton("",new ImageIcon("C:\\Users\\하은\\git\\java\\multi_java\\Image\\치즈토스트.jpg"));

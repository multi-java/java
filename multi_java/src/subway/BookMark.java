...
public class BookMark extends JFrame {// JFrame 상속
	...
	public BookMark() { // 북마크 프레임 생성
		 ...
		 * <레이아웃 구성>
		 * 
		 * 1.(공통GUI)상단 lb => 까페로고, 페이지이름, 레이아웃선 이미지파일 표시 2.(공통GUI)네비게이션바 bt => 마이페이지,
		 * 주문하기, 주문내역, 로그아웃으로 이동할 수 있는 bt 표시 3.주문내역내용 lb => 주문받은 내역을 표시 5.주문내역삭제 bt =>
		 * 주문내역을 삭제할 수 있는 bt 표시 5.총가격 => 4개 주문내역의 총 가격 표시
		 * 
		 **/
